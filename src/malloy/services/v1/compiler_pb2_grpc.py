...
class CompilerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Compile = channel.unary_unary(
        ...
        request_serializer=services_dot_v1_dot_compiler__pb2.CompileRequest.
        SerializeToString,
        response_deserializer=services_dot_v1_dot_compiler__pb2.CompileResponse.
        FromString,
    )
    self.CompileStream = channel.stream_stream(
        ...
        request_serializer=services_dot_v1_dot_compiler__pb2.CompileRequest.
        SerializeToString,
        response_deserializer=services_dot_v1_dot_compiler__pb2.CompilerRequest.
        FromString,
    )
...
class Compiler(object):
  ...
  def Compile(request,
    ...
    return grpc.experimental.unary_unary(
        ...
        services_dot_v1_dot_compiler__pb2.CompileResponse.FromString, options,
  ...
  def CompileStream(request_iterator,
    ...
    return grpc.experimental.stream_stream(
        request_iterator, target, '/malloy.services.v1.Compiler/CompileStream',
        services_dot_v1_dot_compiler__pb2.CompileRequest.SerializeToString,
        services_dot_v1_dot_compiler__pb2.CompilerRequest.FromString, options,
        channel_credentials, insecure, call_credentials, compression,
        wait_for_ready, timeout, metadata)
